...
from torch_geometric.nn import BatchNorm, GCNConv, GraphNorm, SAGEConv, global_mean_pool, MessagePassing, SAGEConv
...
#-------------- Advanced GCN with Regularization + GraphNorm ---------------
class advanced_GCN_graph_norm(torch.nn.Module):
    def __init__(self, num_node_features, hidden_channels=128, dropout=0.05, use_layer_norm=False, use_graph_norm=True, use_residual=True, use_kaiming_init=False):
        super(advanced_GCN_graph_norm, self).__init__()  # Fixed: was super(GCN, ...)
